...
public class PacketCollector {
     ...
     */
    protected PacketCollector(ClientService client, PacketFilter packetFilter) {
    	this(client, packetFilter, 200);
    }
     ...
     */
    protected PacketCollector(ClientService client, PacketFilter packetFilter, int maxSize) {
        this.client = client;
    ...
    public void cancel() {
        ...
        if (!cancelled) {
            cancelled = true;
            client.removePacketCollector(this);
        }
    }
